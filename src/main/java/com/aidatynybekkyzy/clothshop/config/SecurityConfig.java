...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(PRODUCT_ADMIN).hasRole(ADMIN)
                .antMatchers(USER_ADMIN).hasRole(ADMIN)
                .antMatchers(CATEGORY_ADMIN).hasRole(ADMIN)
                .antMatchers(ORDER_ADMIN).hasRole(ADMIN)
                .anyRequest()
                .authenticated()
                .and()
                .sessionManagement()
