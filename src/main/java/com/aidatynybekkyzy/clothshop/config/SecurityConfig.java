...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .disable()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, VENDOR_END_POINT,CATEGORY_END_POINT,PRODUCT_END_POINT).permitAll()
                .antMatchers(AUTH_END_POINT).permitAll()
                .antMatchers(CATEGORY_END_POINT,VENDOR_END_POINT,USER_END_POINT,PRODUCT_END_POINT,ORDER_END_POINT)
                .authenticated()
                .anyRequest()
